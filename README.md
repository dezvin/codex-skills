...
| Должен проверить идею или план сильными вопросами | [`grill-me`](skills/grill-me) |
...
| [`grill-me`](skills/grill-me) | Проверяет идею одним сильным вопросом за раз и отделяет важные решения от мелочей. | Глобально |
...
Эта версия задаёт только вопросы, которые меняют цель, риск, границы,
поведение или следующий шаг, и принимает разумные решения за пользователя в
обратимых мелочах.
